...
- `public/assets/social-card.jpg` is a 1200×630 center crop derived locally from this hero. `public/icons/apple-touch-icon.png` is a 180×180 derivative of the hand-authored icon. No new source imagery or model generation was used for these metadata assets.
